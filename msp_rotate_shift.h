 ...
 * The first number is the shift bit position, and the second number is the size(in bits) of a block.
 ...
 *	xor s0, s1
 *
 * But sometimes, s0 and s1 may be used with swap. Therefore, no instructions are needed.
